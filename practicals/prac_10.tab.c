...
#line 1 "prac_10.y"
	...
	//Name: Ayush Shrikhande,	PRN: 22070521054
	#include <stdio.h>
    #include <stdlib.h>
    #include <string.h>
...
#line 53 "prac_10.y"
                    {
        char *t = newTemp();
        printf("%s = %s + %s\n", t, (yyvsp[-2].code), (yyvsp[0].code));
        free((yyvsp[-2].code));
        free((yyvsp[0].code));
        (yyval.code) = t;
    }
#line 1112 "prac_10.tab.c"
    break;
...
#line 1156 "prac_10.tab.c"
    break;


#line 1160 "prac_10.tab.c"
